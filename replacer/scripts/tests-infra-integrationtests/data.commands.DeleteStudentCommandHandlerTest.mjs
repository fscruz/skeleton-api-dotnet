...
export const file = 'test/Looplex.DotNet.Samples.Academic.Infra.IntegrationTests/Data/Commands/DeleteStudentCommandHandlerTest.cs';
export const outputFile = '{{TESTPROJECT_PATH}}/{{PROJECT_NAMESPACE}}.{{MODULE_NAME}}.Infra.IntegrationTests/Data/Commands/Delete{{RESOURCE_TYPE_NAME}}CommandHandlerTest.cs';
const replaces = [
  {
      original: 'Students',
      find: /Students/g,
